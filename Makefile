# file copied from mp intro

EXENAME = intro
OBJS = PNG.o HSLAPixel.o lodepng.o intro.o main.o
...
intro.o: main.cpp intro.cpp cs225/PNG.h cs225/HSLAPixel.h
	$(CXX) $(CXXFLAGS) main.cpp intro.cpp
